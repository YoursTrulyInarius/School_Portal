...
// Fetch Current Data (Join users to get username/email)
$student = $conn->query("SELECT s.*, u.username, u.email FROM students s JOIN users u ON s.user_id = u.id WHERE s.user_id='$user_id'")->fetch_assoc();
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="profile-card">
                <form method="POST" enctype="multipart/form-data">
                    <div class="profile-header">
                        ...
                        <p style="color: #666; font-weight: 600;"><?php echo htmlspecialchars($student['class_year']); ?></p>
