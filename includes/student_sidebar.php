...
<style>
/* ============================================ */
/* RESPONSIVE MOBILE STYLES - STUDENT SIDEBAR  */
/* ============================================ */
...
<div class="sidebar" id="sidebar">
    ...
    <ul class="sidebar-menu" style="list-style: none; padding: 15px 0; flex: 1; margin: 0;">
        ...
        <li class="<?php echo $current_page == 'my_schedule.php' ? 'active' : ''; ?>">
            <a href="my_schedule.php" style="display: block; padding: 14px 25px; color: rgba(255,255,255,0.85); font-weight: 500; transition: all 0.2s; border-left: 4px solid transparent; <?php echo $current_page == 'my_schedule.php' ? 'background: rgba(255,255,255,0.15); color: white; border-left-color: white;' : ''; ?>">My Schedule</a>
        </li>
        <li class="<?php echo $current_page == 'grades.php' ? 'active' : ''; ?>">
            <a href="grades.php" style="display: block; padding: 14px 25px; color: rgba(255,255,255,0.85); font-weight: 500; transition: all 0.2s; border-left: 4px solid transparent; <?php echo $current_page == 'grades.php' ? 'background: rgba(255,255,255,0.15); color: white; border-left-color: white;' : ''; ?>">My Grades</a>
        </li>
        ...
        <li class="<?php echo $current_page == 'attendance.php' ? 'active' : ''; ?>">
            <a href="attendance.php" style="display: block; padding: 14px 25px; color: rgba(255,255,255,0.85); font-weight: 500; transition: all 0.2s; border-left: 4px solid transparent; <?php echo $current_page == 'attendance.php' ? 'background: rgba(255,255,255,0.15); color: white; border-left-color: white;' : ''; ?>">Attendance</a>
        </li>
        <li>
