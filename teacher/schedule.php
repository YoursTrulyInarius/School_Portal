...
$sql = "SELECT sch.id as schedule_id, 
        ...
        ORDER BY sch.time_start, sch.class_year";
                ...
                <table class="schedule-table">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 25%;" class="hide-mobile">Room</th>
                        </tr>
                    </thead>
                    <tbody>
                    <?php while($row = $result->fetch_assoc()): ?>
                        <tr>
                            <td>
                                <span class="time-display"><?php echo htmlspecialchars($row['time_start'] ?: 'TBA'); ?></span>
                            </td>
                            <td>
                                <span class="subject-name"><?php echo htmlspecialchars($row['subject']); ?></span>
                            </td>
                            <td>
                                <span class="class-badge"><?php echo htmlspecialchars($row['class_year']); ?></span>
                            </td>
                            <td class="hide-mobile">
                                <?php if ($row['room']): ?>
                                    <span class="room-badge"><?php echo htmlspecialchars($row['room']); ?></span>
                                <?php else: ?>
