        ...
        <div class="main-content">
            ...
            <div class="profile-header">
                <div style="display: flex; align-items: center; gap: 20px;">
                    ...
                    <?php else: ?>
                        <div
                            style="width: 100px; height: 100px; border-radius: 50%; background: rgba(255,255,255,0.3); display: flex; align-items: center; justify-content: center; font-size: 2.5rem; color: white; border: 3px solid white;">
                    ...
                    <div style="flex: 1;">
                        ...
                        <p style="margin: 0; opacity: 0.9;">Employee ID:
                            <?php echo htmlspecialchars($teacher['employee_id']); ?></p>
                    </div>
                </div>
                ...
                <div class="info-grid">
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-value"><?php echo htmlspecialchars($teacher['contact_number'] ?: 'N/A'); ?>
                        </div>
                    </div>
                    <div class="info-item">
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    <thead>
                        <tr style="background: var(--primary-color); border-bottom: 2px solid var(--primary-dark);">
                            <th style="padding: 15px; text-align: left; color: white; font-weight: 600;">Room</th>
                            ...
                            <?php while ($sch = $schedules->fetch_assoc()): ?>
                                <tr style="border-bottom: 1px solid #eee;">
                                    <td style="padding: 15px; font-weight: 600; color: var(--primary-color);">
                                        <?php echo htmlspecialchars($sch['room'] ?: '-'); ?>
                                    </td>
                                    <td style="padding: 15px; color: #666;">
                                        <?php echo htmlspecialchars($sch['section_name'] ?: '-'); ?></td>
                                    <td style="padding: 15px; color: #333;">
                                        <?php echo htmlspecialchars($sch['subject'] ?: 'N/A'); ?></td>
                                    <td style="padding: 15px;">
                                        <span
                                            style="background: #eef2f7; padding: 4px 10px; border-radius: 4px; font-size: 0.85rem; color: #555;">
                                            <?php echo htmlspecialchars($sch['day']); ?>
                                        </span>
                                    </td>
                                    <td style="padding: 15px; color: #666;"><?php echo htmlspecialchars($sch['time'] ?: '-'); ?>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
                        <?php else: ?>
                            <tr>
                                <td colspan="5" style="padding: 30px; text-align: center; color: #888;">No classes assigned
                                    yet.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
