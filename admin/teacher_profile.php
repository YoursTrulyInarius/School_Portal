...
$schedules_sql = "SELECT sch.*
                  ...
                  ORDER BY sch.class_year, sch.subject";
                    ...
                    <?php if ($schedules->num_rows > 0): ?>
                        <?php while($sch = $schedules->fetch_assoc()): ?>
                            <tr style="border-bottom: 1px solid #eee;">
                                ...
                                <td style="padding: 15px; color: #333;"><?php echo htmlspecialchars($sch['subject']); ?></td>
                                ...
                                <td style="padding: 15px; color: #666;"><?php echo htmlspecialchars($sch['room'] ?: '-'); ?></td>
                            </tr>
                        <?php endwhile; ?>
                    <?php else: ?>
                        <tr>
