            ...
            if ($stmt->execute()) {
                ...
                if ($req_year && $req_block) {
                    ...
                    if ($sec_res->num_rows > 0) {
                        ...
                        $suffix = 'th';
                        if ($req_year == 1) $suffix = 'st';
                        elseif ($req_year == 2) $suffix = 'nd';
                        elseif ($req_year == 3) $suffix = 'rd';
                        
                        if (!$req_course) $gl_display = "Grade " . $req_year; // SHS
                        else $gl_display = $req_year . $suffix . " Year"; // College
                ...
                if ($stmt2->execute()) {
                    ...
                    try {
                        ...
                        $mail->Password   = 'passwordexample';     // Replace with your Gmail App Password
                        ...
                        // Recipients
                        $mail->setFrom('example@gmail.com', 'Westprime Horizon Institute');
            ...
            <table style="width: 100%; border-collapse: collapse; min-width: 700px;">
                <thead>
                    <tr style="background: #0056b3; border-bottom: 2px solid #004494;">
                        ...
                        <th style="padding: 15px; text-align: left; color: white; font-weight: 600;">Grade Level / Course</th>
                        <th style="padding: 15px; text-align: center; color: white; font-weight: 600;">Status</th>
                ...
                <tbody>
                                        ...
                                        <form method="POST" style="display: inline;">
                                            ...
                                            <div style="margin-bottom: 5px;">
                                                <label style="font-size: 0.85rem; cursor: pointer;">
                                                    <input type="checkbox" name="is_scholar" value="1"> Scholar (Free Tuition)
                                                </label>
                                            </div>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="5" style="padding: 30px; text-align: center; color: #888;">No enrollment requests found.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
