        ...
        if ($check->num_rows > 0) {
            ...
            if ($conn->query($sql) === TRUE) {
                ...
                if ($role == 'student') {
                    ...
                    $conn->query($s_sql);
                    $msg = "Registration successful! Your LRN is <strong>$lrn</strong>. Please login.";
                    ...
                    $emp_id = 'T' . date('Y') . rand(1000, 9999);
                     ...
                     $conn->query($t_sql);
                     $msg = "Registration successful! Your Employee ID is <strong>$emp_id</strong>. Please login.";
                }
